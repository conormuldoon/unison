...
### Binary
Unison requires Java 11 to operate. Download and run the [latest release](https://github.com/conormuldoon/unison/releases/latest/download/unison-server-0.1.0-SNAPSHOT.jar) and open `http://localhost:8080/unison/index.html` in the browser. To change the port, use the `--server.port`argument for main.
